...
$backendCmd = "cd `"$root\backend`"; uvicorn app.main:app --host 0.0.0.0 --port 8000"
...
Write-Host ""
Write-Host "Para simulador: python scripts/driver_simulator.py --drivers 10" -ForegroundColor Gray
Write-Host ""
