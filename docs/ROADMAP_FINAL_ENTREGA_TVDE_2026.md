...
Registo de tempos (**L-09**) · retenção actividade 2 anos (**L-11**) · retenção reclamações 2 anos (**L-12**) · hard-cap comissão 25% sem IVA (**L-13** — guard 0–25% implementado; base IVA por validar; não CLOSED) · demonstração de cálculo / breakdown (**L-14**) · taxa de intermediação (**L-15** — snapshot 15% na viagem e na UI do passageiro; factura L-16 fora; não CLOSED) · fatura electrónica (**L-16**) · reporting mensal AMT (**L-17**) · apuramento contribuição AMT 5% (**L-18**) · contratos de adesão operadores (**L-23**) · disponibilização contrato ao motorista (**L-24**) · Livro de Reclamações / RAL (**L-25**) · processos comunicação IMT/AMT (**L-29**).
