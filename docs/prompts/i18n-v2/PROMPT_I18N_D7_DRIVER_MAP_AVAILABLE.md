# D7 — i18n driver-map-available

**ID:** `D7` · **Branch:** `feat/i18n-d7-driver-map-available` · **Depende de:** X2
...
git checkout -b feat/i18n-d7-driver-map-available
```

## Objectivo

Secções mapa/lista motorista disponível. ActiveTripActions: só auditar (já migrado em v1).

## Ficheiros (âmbito)

- [`features/driver/DriverDashboard.tsx`](../../web-app/src/features/driver/DriverDashboard.tsx)
...
```bash
rg "[À-ú]" web-app/src/features/driver/DriverDashboard.tsx
```
...
```
feat(i18n): driver-map-available
```
