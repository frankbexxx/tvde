# R2 — i18n partner-fleet

**ID:** `R2` · **Branch:** `feat/i18n-r2-partner-fleet` · **Depende de:** R1
...
git checkout -b feat/i18n-r2-partner-fleet
```

## Objectivo

Ecrãs frota parceiro.

## Ficheiros (âmbito)

- [`features/partner/PartnerFleetScreen.tsx`](../../web-app/src/features/partner/PartnerFleetScreen.tsx)
- [`features/partner/PartnerDriversList.tsx`](../../web-app/src/features/partner/PartnerDriversList.tsx)
...
```bash
rg "[À-ú]" web-app/src/features/partner/PartnerFleetScreen.tsx web-app/src/features/partner/PartnerDriversList.tsx
```
