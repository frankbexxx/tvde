# R5 — i18n partner-detail

**ID:** `R5` · **Branch:** `feat/i18n-r5-partner-detail` · **Depende de:** R2, R3
...
git checkout -b feat/i18n-r5-partner-detail
```

## Objectivo

Detalhe motorista/viagem. Smokes NAV-P em PT default.

## Ficheiros (âmbito)

- [`features/partner/PartnerDriverDetail.tsx`](../../web-app/src/features/partner/PartnerDriverDetail.tsx)
- [`features/partner/PartnerTripDetail.tsx`](../../web-app/src/features/partner/PartnerTripDetail.tsx)
...
```bash
rg "[À-ú]" web-app/src/features/partner/PartnerDriverDetail.tsx web-app/src/features/partner/PartnerTripDetail.tsx
```
