...
**ID:** `R4` · **Branch:** `feat/i18n-r4-partner-ops` · **Depende de:** R1
...
git checkout -b feat/i18n-r4-partner-ops
```

## Objectivo

Relatórios, caixa, perfil, settings menu parceiro.
