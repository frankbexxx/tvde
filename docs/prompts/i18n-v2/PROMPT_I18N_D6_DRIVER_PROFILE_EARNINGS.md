# D6 — i18n driver-profile-earnings

**ID:** `D6` · **Branch:** `feat/i18n-d6-driver-profile-earnings` · **Depende de:** D1
...
git checkout -b feat/i18n-d6-driver-profile-earnings
```

## Objectivo

Perfil, rendimentos (settings → X0).
...
### Summary
- i18n EN: driver-profile-earnings
...
```
feat(i18n): driver-profile-earnings
```
