# R6 — i18n partner-home

**ID:** `R6` · **Branch:** `feat/i18n-r6-partner-home` · **Depende de:** R1
...
git checkout -b feat/i18n-r6-partner-home
```

## Objectivo

Home + alerts parceiro.

## Ficheiros (âmbito)

- [`features/partner/PartnerHome.tsx`](../../web-app/src/features/partner/PartnerHome.tsx)
...
```bash
rg "[À-ú]" web-app/src/features/partner/PartnerHome.tsx
```
