# X0 — i18n settings-shell

**ID:** `X0` · **Branch:** `feat/i18n-x0-settings-shell` · **Depende de:** P6, D6
...
git checkout -b feat/i18n-x0-settings-shell
```

## Objectivo

Activity log, dev tools, strings exclusivas motorista. **Não** duplicar LanguageSelector / AppAppearanceSettings.

## Ficheiros (âmbito)

- [`design-system/components/app/SettingsButton.tsx`](../../web-app/src/design-system/components/app/SettingsButton.tsx)
...
```bash
rg "[À-ú]" web-app/src/design-system/components/app/SettingsButton.tsx
```
