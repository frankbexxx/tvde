# P1P2 — i18n passenger-map-sheets

**ID:** `P1P2` · **Branch:** `feat/i18n-p1p2-passenger-map-sheets` · **Depende de:** X1
...
git checkout -b feat/i18n-p1p2-passenger-map-sheets
```

## Objectivo

MapBottomSheet idle + trip: planner, GPS, viagem activa, payment card, status.

## Ficheiros (âmbito)

- [`features/passenger/TripPlannerPanel.tsx`](../../web-app/src/features/passenger/TripPlannerPanel.tsx)
- [`features/passenger/DestinationSearchField.tsx`](../../web-app/src/features/passenger/DestinationSearchField.tsx)
- [`features/passenger/PassengerDashboard.tsx`](../../web-app/src/features/passenger/PassengerDashboard.tsx)
- [`features/passenger/PassengerStatusCard.tsx`](../../web-app/src/features/passenger/PassengerStatusCard.tsx)
- [`features/passenger/PassengerPaymentConfirmCard.tsx`](../../web-app/src/features/passenger/PassengerPaymentConfirmCard.tsx)
...
```bash
rg "[À-ú]" web-app/src/features/passenger/TripPlannerPanel.tsx web-app/src/features/passenger/DestinationSearchField.tsx web-app/src/features/passenger/PassengerDashboard.tsx web-app/src/features/passenger/PassengerStatusCard.tsx web-app/src/features/passenger/PassengerPaymentConfirmCard.tsx
```
...
```
feat(i18n): passenger-map-sheets
```
