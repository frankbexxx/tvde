# P3 — i18n passenger-cancel-rating

**ID:** `P3` · **Branch:** `feat/i18n-p3-passenger-cancel-rating` · **Depende de:** P1P2
...
git checkout -b feat/i18n-p3-passenger-cancel-rating
```

## Objectivo

Cancelamento inline + painel de avaliação passageiro.

## Ficheiros (âmbito)

- [`features/passenger/PassengerDashboard.tsx`](../../web-app/src/features/passenger/PassengerDashboard.tsx)
- [`features/passenger/PassengerTripRatingPanel.tsx`](../../web-app/src/features/passenger/PassengerTripRatingPanel.tsx)
...
```bash
rg "[À-ú]" web-app/src/features/passenger/PassengerDashboard.tsx web-app/src/features/passenger/PassengerTripRatingPanel.tsx
```
...
### Summary
- i18n EN: passenger-cancel-rating
...
```
feat(i18n): passenger-cancel-rating
```
