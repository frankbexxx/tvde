# P4P5 — i18n passenger-menu

**ID:** `P4P5` · **Branch:** `feat/i18n-p4p5-passenger-menu` · **Depende de:** X1, P1P2
...
git checkout -b feat/i18n-p4p5-passenger-menu
```

## Objectivo

Menu passageiro: root, settings, history, history_detail. **Usar chaves X1** para Voltar/Fechar.

## Ficheiros (âmbito)

- [`features/passenger/PassengerSideMenu.tsx`](../../web-app/src/features/passenger/PassengerSideMenu.tsx)
- [`features/passenger/PassengerHistoryDetailPanel.tsx`](../../web-app/src/features/passenger/PassengerHistoryDetailPanel.tsx)
...
```bash
rg "[À-ú]" web-app/src/features/passenger/PassengerSideMenu.tsx web-app/src/features/passenger/PassengerHistoryDetailPanel.tsx
```
