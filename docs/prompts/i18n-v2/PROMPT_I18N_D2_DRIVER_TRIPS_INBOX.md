# D2 — i18n driver-trips-inbox

**ID:** `D2` · **Branch:** `feat/i18n-d2-driver-trips-inbox` · **Depende de:** D1
...
git checkout -b feat/i18n-d2-driver-trips-inbox
```

## Objectivo

Viagens, silenciadas, inbox.
