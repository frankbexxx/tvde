# P6 — i18n passenger-account

**ID:** `P6` · **Branch:** `feat/i18n-p6-passenger-account` · **Depende de:** P4P5
...
git checkout -b feat/i18n-p6-passenger-account
```

## Objectivo

Conta passageiro / beta account. Referenciar `common.legalEnSummary` se termos legais.

## Ficheiros (âmbito)

- [`design-system/components/app/ProfileButton.tsx`](../../web-app/src/design-system/components/app/ProfileButton.tsx)
- [`features/account/BetaAccountPanel.tsx`](../../web-app/src/features/account/BetaAccountPanel.tsx)
...
```bash
rg "[À-ú]" web-app/src/design-system/components/app/ProfileButton.tsx web-app/src/features/account/BetaAccountPanel.tsx
```
