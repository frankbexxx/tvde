# D3 — i18n driver-nav-categories

**ID:** `D3` · **Branch:** `feat/i18n-d3-driver-nav-categories` · **Depende de:** D1
...
git checkout -b feat/i18n-d3-driver-nav-categories
```

## Objectivo

Navegação, categorias, preços.
...
```
feat(i18n): driver-nav-categories
```
