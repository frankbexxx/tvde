# R3 — i18n partner-trips

**ID:** `R3` · **Branch:** `feat/i18n-r3-partner-trips` · **Depende de:** R1
...
git checkout -b feat/i18n-r3-partner-trips
```

## Objectivo

Ecrãs viagens parceiro.

## Ficheiros (âmbito)

- [`features/partner/PartnerTripsScreen.tsx`](../../web-app/src/features/partner/PartnerTripsScreen.tsx)
...
```bash
rg "[À-ú]" web-app/src/features/partner/PartnerTripsScreen.tsx
```
