# D4 — i18n driver-zones

**ID:** `D4` · **Branch:** `feat/i18n-d4-driver-zones` · **Depende de:** D3
...
git checkout -b feat/i18n-d4-driver-zones
```

## Objectivo

Zonas (4 ecrãs) — **PR isolado**, não misturar com D3.
