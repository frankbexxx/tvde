# X1 — i18n app-menu-shell

**ID:** `X1` · **Branch:** `feat/i18n-x1-app-menu-shell` · **Depende de:** E0
...
git checkout -b feat/i18n-x1-app-menu-shell
```

## Objectivo

Chaves `common.*` para Voltar, Fechar, secções; menus downstream **consumem** estas chaves (não duplicar em P4P5/D1/R1).

## Ficheiros (âmbito)

- [`components/layout/AppMenuShell.tsx`](../../web-app/src/components/layout/AppMenuShell.tsx)

## Regra downstream

Prompts P4P5, D1, R1: usar `t('common:back')`, `t('common:close')` — não criar chaves duplicadas.
...
```bash
rg "[À-ú]" web-app/src/components/layout/AppMenuShell.tsx
```
