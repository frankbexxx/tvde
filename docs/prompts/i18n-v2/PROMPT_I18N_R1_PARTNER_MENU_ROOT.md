# R1 — i18n partner-menu-root

**ID:** `R1` · **Branch:** `feat/i18n-r1-partner-menu-root` · **Depende de:** X1, P4P5
...
git checkout -b feat/i18n-r1-partner-menu-root
```

## Objectivo

Menu parceiro root. Após passageiro menu mínimo.

## Ficheiros (âmbito)

- [`features/partner/PartnerSideMenu.tsx`](../../web-app/src/features/partner/PartnerSideMenu.tsx)
...
```bash
rg "[À-ú]" web-app/src/features/partner/PartnerSideMenu.tsx
```
