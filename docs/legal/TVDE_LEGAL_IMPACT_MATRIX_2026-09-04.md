...
| **L-25** | **Reclamações** (Livro Electrónico) + informação **RAL** | Art. 19.º n.ºs 2–3 | `PARCIAL` | `GAP OPERACIONAL EXTERNO` | `NECESSÁRIO M2` | **`PARCIAL — foundation técnica validada em produção; pendências externas/operacionais`** (`474a242`) · ver [`L25_LIVRO_RECLAMACOES_RAL_2026-09-07.md`](L25_LIVRO_RECLAMACOES_RAL_2026-09-07.md) · O-L25-07/08 concluídos · fecho só após O-L25-01…06/09 |
