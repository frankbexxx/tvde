...
| **L-11** | Retenção **2 anos** actividade operador/motorista/veículo | Art. 13.º n.º 3 | `PARCIAL` | `GAP LEGAL/PROCESSO` | `NECESSÁRIO M2` | **Hotfix 2026-09-05:** `AUDIT_EVENTS_RETENTION_DAYS` default **730** — `PARCIAL — risco de purge precoce corrigido; cobertura completa de activity retention ainda pendente` |
