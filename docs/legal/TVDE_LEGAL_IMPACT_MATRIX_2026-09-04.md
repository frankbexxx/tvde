...
| **L-25** | **Reclamações** (Livro Electrónico) + informação **RAL** | Art. 19.º n.ºs 2–3 | `PARCIAL` | `GAP OPERACIONAL EXTERNO` | `NECESSÁRIO M2` | **`PARCIAL — foundation técnica OK; ops LRE após domínio `vamula.pt` (DEPENDÊNCIA EXTERNA .PT); NÃO BLOQUEADOR IMEDIATO do desenvolvimento APP`** · acta [`VAMULA_DECISOES_OPERACIONAIS_2026-09-09.md`](../business/VAMULA_DECISOES_OPERACIONAIS_2026-09-09.md) · [`L25_…`](L25_LIVRO_RECLAMACOES_RAL_2026-09-07.md) · O-L25-07/08 concluídos · fecho global só após O-L25-01…06/09 |
