...
| **L-12** | Retenção **2 anos** reclamações / processo | Art. 19.º n.º 3 | `PARCIAL` | `GAP LEGAL/PROCESSO` | `NECESSÁRIO M2` | **`PARCIAL — complaint foundation 2026-09-07`**: modelo `Complaint` + `ComplaintHistory` · retenção `submitted_at + 2 anos civis` · APIs + Admin · **sem** attachments · L-25 separado |
