...
| **L-25** | **Reclamações** (Livro Electrónico) + informação **RAL** | Art. 19.º n.ºs 2–3 | `PARCIAL` | `GAP OPERACIONAL EXTERNO` | `NECESSÁRIO M2` | **`PARCIAL — foundation técnica OK; link directo LRE CONFIGURADO 2026-09-22 (loja VAMULÁ); O-L25-05 gestor CONCLUÍDO 2026-09-22 (titular Manel Perez, substituto Francisco Bexiga); canal AMT O-L25-06 CONCLUÍDO; L-25 global ainda aberto em O-L25-02, 03, 04 e 09; NÃO BLOQUEADOR IMEDIATO do desenvolvimento APP`** · acta [`VAMULA_DECISOES_OPERACIONAIS_2026-09-09.md`](../business/VAMULA_DECISOES_OPERACIONAIS_2026-09-09.md) · [`L25_…`](L25_LIVRO_RECLAMACOES_RAL_2026-09-07.md) · O-L25-01/05/06/07/08 concluídos · fecho global só após O-L25-02, 03, 04 e 09 |
