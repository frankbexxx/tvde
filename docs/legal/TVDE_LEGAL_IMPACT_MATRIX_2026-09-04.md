...
| **L-25** | **Reclamações** (Livro Electrónico) + informação **RAL** | Art. 19.º n.ºs 2–3 | `PARCIAL` | `GAP OPERACIONAL EXTERNO` | `NECESSÁRIO M2` | **`PARCIAL — foundation técnica 2026-09-07`**: Admin import LRE/RAL · links LRE + RAL (CACCL/CNIACC, copy prudente) · livro físico **NÃO APLICÁVEL** sem estabelecimento presencial · **registo Ventos Férteis no portal LRE ainda pendente** |
