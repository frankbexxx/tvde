...
| **L-SEC-14A** | P3 → **CLOSED** | Partner | ~~`GET /partner/trips` sem bound.~~ Cap 500 newest; export histórico sem cap. | #TBD; `partner_queries.PARTNER_TRIP_LIST_LIMIT`; `test_l_sec_14a_partner_trips_cap.py` | — | Fechado |
