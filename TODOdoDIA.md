...
| **TW-04** | Acções viagem: nav externa + CTAs row + chrome opaco | Em curso | `feat/tw-04-trip-actions`; smoke pós-merge |
...
| **TW-04** | Acções viagem: nav externa + CTAs row + chrome opaco | Em curso | PR `feat/tw-04-trip-actions` |
