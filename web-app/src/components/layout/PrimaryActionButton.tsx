...
export function PrimaryActionButton({
  ...
  const base =
    'w-full min-h-[52px] min-w-[44px] rounded-full font-bold text-lg shadow-floating hover:scale-105 active:scale-95 transition-all duration-150 ease-out disabled:opacity-50 disabled:hover:scale-100 disabled:active:scale-100 touch-manipulation'
  const styles =
    variant === 'danger'
